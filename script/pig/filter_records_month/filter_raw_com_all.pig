...
p1 = FILTER dnsrequests by (ts is not null) AND (type == 0) AND (domain is not null) AND (qtype != 0);
...
STORE p5 INTO '/user/pdhakshi/pigouts/filter_results_month/filter_raw_com_all.gz';
