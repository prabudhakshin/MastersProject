...
rawcsv = LOAD '/feeds/sie/ch202/201202/raw_processed.{201202}*.0.gz' as (line:chararray);
...
p2 = FOREACH p1 GENERATE qtype;

p3 = GROUP p2 by qtype;

p4 = FOREACH p3 GENERATE group as qtype, COUNT(p2) as query_type_count;

p5 = GROUP p4 ALL;

p6 = FOREACH p5 GENERATE FLATTEN($1);

STORE p6 INTO '/user/pdhakshi/output_query_type_count';
