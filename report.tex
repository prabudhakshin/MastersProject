...
\begin{figure}[h] 
\includegraphics[width=1\linewidth]{./data/RESULTS/graphs/tld_distribution_newcol.png}
\caption {\textit{Distribution of log records by TLD.}}
\end{figure}

\begin{figure}[H] 
\centering
\includegraphics[width=1\textwidth]{./data/RESULTS/graphs/qtype_distribution_newcol.png}
...
\begin{figure}[H] 
\centering
\includegraphics[width=1\textwidth]{./data/RESULTS/graphs/qtype_tld_dist_newcol.png}
...
\begin{figure}[H] 
\centering
\includegraphics[width=0.8\linewidth]{./data/RESULTS/graphs/domain_vs_numbuckets_per.png}
...
%\subsubsection{Implementation Details}
%To remove the unessential records, first records are grouped based on the tuple \\$<$src\_ip, domain, query\_type$>$ and within each group, records are sorted in the non-decreasing order of the timestamp. Then, we use a simplified version\footnotemark \ of equation (1) to remove unessential records.
%\begin{itemize}
...
%	\item {If the records are within 3 seconds apart and if the answer section is present in the $1^{st}$ record, then the $2^{nd}$ record belongs to a different request. Otherwise (answer not present in $1^{st}$ record), the records are considered part of the same request.}
%\end{itemize}
\footnotetext {In our implementation, we did not consider the constraint $(authoritative_{1i5} = additional_{1j1})\ \wedge\ (dst\_ip_{2} = additional_{1j5})$}
...
\begin{figure}[H] 
\centering
\includegraphics[width=1\textwidth]{./data/RESULTS/graphs/diskusage_by_ordering_1completeday_newcol.png}
...
\begin{figure}[H] 
\centering
\includegraphics[width=1\textwidth]{./data/RESULTS/graphs/diskusage_by_techniques_30day_newcol.png}
...
\begin{figure}[H] 
\centering
\includegraphics[width=1\textwidth]{./data/RESULTS/graphs/30day_com_A_newcol.png}
...
\begin{figure}[H] 
\centering
\includegraphics[width=1\textwidth]{./data/RESULTS/graphs/30day_com_all_newcol.png}
...
\begin{figure}[H] 
\centering
\includegraphics[width=1\textwidth]{./data/RESULTS/graphs/30day_all_A_newcol.png}
...
\begin{figure}[H] 
\centering
\includegraphics[width=1\textwidth]{./data/RESULTS/graphs/30day_all_all_newcol.png}
